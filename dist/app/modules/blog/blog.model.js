...
const blogSchema = new mongoose_1.Schema({
    ...
    category: {
        type: String,
        required: true,
        enum: Object.values(blog_interface_1.BlogCategory)
    },
    tags: [{
            type: String,
            trim: true,
...
blogSchema.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (this.isNew || this.isModified('title')) {
            ...
            while (yield exports.Blog.findOne({ slug, _id: { $ne: this._id } })) {
        ...
        if (this.isModified('status') && this.status === blog_interface_1.BlogStatus.PUBLISHED && !this.publishedAt) {
...
blogSchema.statics.findPublished = function () {
    return this.find({ status: blog_interface_1.BlogStatus.PUBLISHED }).sort({ publishedAt: -1 });
};
...
blogSchema.methods.addComment = function (commentData) {
    this.comments.push(Object.assign(Object.assign({}, commentData), { isApproved: false // Always require approval
     }));
    return this.save();
};
